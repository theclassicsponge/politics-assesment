...
Lastly, using the means I worked out in the table. I will conduct two sample T-tests on the variables to test if the differences in the effect of the variables identified in the plots are statistically significant. A two sample T-test is a type of hypothesis test used to compare whether the difference between the means of two groups is statistically significant or if it due just to random chance. 
